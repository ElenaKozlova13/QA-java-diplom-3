...
public class WebDriverCreator {
    ...
    //имя файла драйвера Яндекс браузера (Хромдрайвер 110.0.5481.77)
    public static final String YANDEX_BROWSER_DRIVER_FILENAME = "chromedriverYa.exe";
    //путь к исполняемому файлу Яндекс браузера в системе
    public static final String YANDEX_BROWSER_PATH = "C:\\Users\\blood\\AppData\\Local\\Yandex\\YandexBrowser\\Application";
